...
export const MessageResponse = memo(
  ({ className, children, ...props }: MessageResponseProps) => {
    ...
    return (
      <div className={cn("size-full space-y-3 whitespace-pre-wrap leading-relaxed", className)} {...props}>
        {blocks.map((block, index) => {
          ...
          if (trimmed.startsWith("```") && trimmed.endsWith("```")) {
            return (
              <pre key={index} className="overflow-x-auto rounded-2xl bg-muted p-4 text-xs leading-relaxed">
